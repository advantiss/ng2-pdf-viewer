import { FieldConfiguration } from '../../pdf-viewer/interfaces/field-configuration.class';
import { SUPPORTED_FORM_FIELD_TYPES, SUPPORTED_DATA_TYPES } from '../../pdf-viewer/constants';

/**
 * An enum of all necessary form fields (from the PDF) and their corresponding HTML input `name` property.
 * Used for `DOM` selection of input fields for setting and fetching values.
 */
